<div class="col-lg-12">
    <div class="card" style="background-color: #181824">
        <div class="card-body">
            <h3 class="text-center font-weight-bold text-white">Pesanan </h3>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="p-2  border">
                                <h2 class="h3 mb-3 text-white ml-3">Detail Informasi</h2>
                        ...
                        <div class="col-md-5">
                            <div class="p-2  border">
                                <h2 class="h3 mb-3 text-white ml-3">Tujuan Pesanan</h2>
                                <table class="table  mb-5">
                                    <tbody>
                                        <tr>
            ...
            <div class="col-12 mt-5">
                <div class="container">
                    <div class="row justify-content-center mb-3">
                        <h4 class="text-white">Pesanan Detail</h4>
                    </div>
                    <div class="container">
                        <table class="table table-sm">
                            <thead>
                                <tr class="">
                                    <th class="text-white" style=" width: 100px">Gambar</th>
                            ...
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-white text-center">
                                        <h6 class=" ">{{$detail->barang->name}}</h6>
                                    </td>
